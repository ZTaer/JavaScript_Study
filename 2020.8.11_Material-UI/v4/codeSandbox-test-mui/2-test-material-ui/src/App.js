...
import TestPages from "./pages/testpages/testpages.component";
import SkeletonPages from "./pages/skeletonpages/skeleton-pages.component";
      ...
      <Switch>
        <ErrorBoundary>
          <Suspense fallback={<Spinner />}>
            ...
            <Route exact={true} path="/ske" component={SkeletonPages} />
          </Suspense>
        </ErrorBoundary>
      </Switch>
    </div>
