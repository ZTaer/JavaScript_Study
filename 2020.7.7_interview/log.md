...
# 资源
    ...
    b) 算法
        ...
        3. 算法博客( 书岩推荐 ): http://www.cyc2018.xyz/#%E7%AE%97%E6%B3%95
</pre>
...
# 野生算法
    ...
    c) 算法
        0. 动态规划 | 高频
        1. 深度优先搜索 | 高频 | DFS ( 经常对比DFS/BFS ) 
        2. 广度优先搜索 | 思路重要 | BFS
        3. 贪心 | 思路重要
        4. 二分查找 | 简单介绍 | 难 | 有序数列二分 | check函数
        5. 回溯 | 类似DFS | 不常见
        6. 递归 | 基础
        7. 分治 | 归并排序
        8. 记忆搜索 | 动态规划,记忆化搜索,对比询问
        9. 快速选择
    d) 基础数据结构
        0. 哈希表 | 高频
        1. 树 | 高频
