...
/**
 * 实例索引: 限制用户评论，一个tour用户只能评论一次( 完成笔记 )
 * 配置复合索引: userId+tourId保持唯一 ( 完成笔记 )
...
/**
 * 静态方法实例: 计算指定tour评论的"平均评分"以及"评论数量"( 完成笔记 )
...
/**
 * 应用静态方法实例: 创建评论时计算"平均评分"以及"评论数量" ( 完成笔记 )
...
/**
 * 应用静态方法实例: 删除/更新评论时计算"平均评分"以及"评论数量" ( 完成笔记 )
 *      a) 构建: 预中间件
